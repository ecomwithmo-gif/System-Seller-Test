    ...
    <header className="h-16 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between px-6 sticky top-0 z-10">
      ...
      <div className="flex items-center gap-4 flex-1 max-w-xl">
        <div className="relative flex-1">
          ...
          <Input
            type="search"
            placeholder="Search orders, SKUs, ASINs..."
            className="pl-10"
            value={searchQuery}
      ...
      <div className="flex items-center gap-4">
        ...
        <Button variant="outline" size="icon" className="relative" title="Notifications">
          ...
          <span className="absolute -top-1 -right-1 w-3 h-3 bg-amazon-orange rounded-full text-[8px] flex items-center justify-center text-white font-bold">
            3
          </span>
        </Button>
